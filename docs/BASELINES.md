...
> are from the 2026-07-11 entity-obs re-baseline (0.13.0, #238): the shipped
...
- **The model leads on MAE and CRPS and roughly ties ridge on RMSE and R².**
  Against ridge (5.38 / 7.68 / 0.498 / 4.02) it wins MAE (5.28) and CRPS (3.81)
  clearly, edges RMSE (7.67 vs 7.68), and ties R² exactly (0.498). The point-signal
  lead the 0.6.0 `gbm_offset` stacking block opened (#86) has narrowed to a tie on
  R²/RMSE under the entity-obs re-baseline — the win is now MAE, CRPS, and modeled
...
- **The GBM's residual intervals remain over-confident** (0.763 / 0.888
  ...
  0.853 — and remain the *narrowest* calibrated ones (31.0 vs conformal's 33.6
  and ridge's 32.2).
...
The model **leads this table outright** (6.82 / 0.117) and is the only method
with 95% coverage at nominal (0.965); its cold-start intervals are
appropriately *wider* than the within-entity ones (43.5 vs 31.0). Two 0.6.0
...
(`user_score_20260712_014147.nc`, the 2026-07-11 entity-obs re-baseline for
