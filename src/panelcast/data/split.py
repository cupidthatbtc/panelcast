...
# ---------------------------------------------------------------------------
# Backward-compatible aliases (AOTY-flavored names -> role-based names).
#
# The split strategies were renamed artist -> entity for domain portability.
# These thin wrappers preserve the old public function names and the old
# ``artist_col`` keyword so external callers and pre-rename code keep working.
# ---------------------------------------------------------------------------
