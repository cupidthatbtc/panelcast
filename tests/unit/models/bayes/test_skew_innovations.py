...
def test_random_walk_site_names_share_separator_and_exact_gate():
    ...
    assert rw_latent_sites("user", "skew_normal").present() == (
        "user_rw_raw",
        "user_rw_raw_abs",
    )
    assert rw_latent_sites("user_", "normal").present() == ("user_rw_raw",)
