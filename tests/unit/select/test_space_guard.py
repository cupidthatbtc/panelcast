...
class TestFieldCoverage:
    ...
    def test_every_gates_literal_reaches_a_config_field(self):
        ...
        # likelihood_family widened to str for plugin families (#172) and
        # target_transform to str|None for descriptor deferral (#268); the
        # Literals remain the documented builtin sets.
        used |= {"LikelihoodFamily", "TargetTransform"}
